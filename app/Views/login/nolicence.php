...
<body style="background-color: #ffffff">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img style="width: 100%" src="<?php echo base_url() ?>/images_all/messa_nolink.png" />
            ...
            <div class="col-lg-6">
                ...
                <fieldset>
                    <div class="alert alert-danger">
                        <h4><strong>Erreur!</strong> Votre licence Messa n'est plus valide.<br>
                            Contacter un Responsable commercial pour commander des licences.<br><br>
                            <i class="fa fa-envelope" aria-hidden="true"></i> Email: admin@doralya.com<br>
                            <i class="fa fa-phone" aria-hidden="true"></i> Tél: (+509) 41 69 5616
                        </h4>
                    </div>
                    <div class="clearfix">

                        <a href="app" class="width-65 btn btn-lg btn-primary">
                            <i class="ace-icon fa fa-sign-in"></i>
                            <span class="bigger-110" id="de"><?php echo $lang['btn_login'][$l_lan] ?></span>
                        </a>
                    </div>
