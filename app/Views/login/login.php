            ...
            <div class="col-lg-6">
                ...
                <form>
                    <fieldset>
                        ...
                        <label class="block clearfix"><strong>
                                <?php echo $lang['pass_login'][$_SESSION['lang']] ?>
                                :</strong>
                            <span class="block input-icon input-icon-right">
                                <input maxlength="50" type="password" class="form-control" id="password" placeholder="<?php echo $lang['pass_login'][$l_lan] ?>" />
                        ...
                        <div class="clearfix">
                            <div id="erreur" class="alert alert-danger hide">
                                <?php echo $lang['mes_login'][$l_lan] ?>
                            </div>

                            <button type="button" onclick="ConnectApp()" id="btn_connect" class="width-55 btn btn-lg btn-primary">
                        ...
                        <br>
                        <h4><a href="<?php echo base_url() ?>/mot-de-passe-oublier"><?php echo $lang['forget'][$l_lan] ?></a></h4>
                    </fieldset>
                </form>
            </div>
